...
class DataError(Enum):
    ...
    LICENSE_NULL_POINTER_ERR = '03'
    LICENSE_LIC_SIZE_INVALID = '04'
    LICENSE_ALG_INIT_FAIL = '05'
    LICENSE_DECRYPT_FAIL = '06'
    LICENSE_BODY_LEN_INVALID = '07'
    LICENSE_HID_VERIFY_FAIL = '08'
    LICENSE_PARA_LENGTH_ERR = '09'
    LICENSE_MEMORY_MALLOC_FAIL = '0B'
    LICENSE_NOT_NOT_FOUND = '0F'
    LICENSE_WRITE_SAME_FAIL = '10'
    LICENSE_UART_NO_HEADER = '14'
    LICENSE_UART_RECV_TIMEOUT = '15'
    LICENSE_UART_CHECKSUM_FAIL = '16'
    LICENSE_UART_CMD_ERR = '17'
    LICENSE_NET_CREATE_CON_FAIL = '19'
    LICENSE_NET_SEND_MSG_FAIL = '1A'
    LICENSE_NET_RECV_TIME_OUT = '1B'
    LICENSE_NET_RECV_CMD_INVALID = '1C'
    LICENSE_NET_RECV_CPID_INVALID = '1D'
    LICENSE_NET_LIC_MAKE_FAIL = '20'
    LICENSE_READ_DID_FAIL = '21'
    LICENSE_FLASH_NO_SPACE = '22'
    LICENSE_FLASH_NOT_FOUND = '23'
    LICENSE_FLASH_ERASE_FAIL = '24'
    LICENSE_FLASH_WRITE_FAIL = '25'
    LICENSE_FLASH_READ_FAIL = '26'
